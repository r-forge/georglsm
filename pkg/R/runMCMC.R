...
# and set number of running cores
# for exampel, options(cores=4)
####################################
...
####################################
predY <- function(res.m, loc, locp, X=NULL, Xp=NULL, Lp=0, k=1, rho.family="rhoPowerExp", Y.family="Poisson"){
